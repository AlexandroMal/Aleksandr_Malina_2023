...
public class UserService : IUserService
{
    ...
    {
        if(string.IsNullOrEmpty(userModel.Name) || string.IsNullOrEmpty(userModel.Surname) || string.IsNullOrEmpty(userModel.Password))
        {
    ...
    public async Task UpdateUserAsync(UpdateUserModel userModel)
    {
        ...
        var mapper = _mapper.Map(userModel, user);
